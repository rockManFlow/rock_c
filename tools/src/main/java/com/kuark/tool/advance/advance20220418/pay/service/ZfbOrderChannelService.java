...
@Service
@Slf4j
public class ZfbOrderChannelService extends AbstractChannelService<WxAuthReqModel, WxAuthRespModel> {

    public ZfbOrderChannelService(){
        super(ChannelServiceEnum.ZFB_PAY_ORDER);
    }

    @Override
    public WxAuthRespModel invoke(WxAuthReqModel request) {
        log.info("run invoke:{}",ChannelServiceEnum.ZFB_PAY_ORDER);
        return null;
    }
}
