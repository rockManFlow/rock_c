...
public final class RegExValidateUtils {
    ...
    private static final String  MOBILE_PATTERN    = "^(1[1-9][0-9])[0-9]{8}$";
    private static final String  IDCARD_PATTERN    = "(^\\d{15}$)|(^\\d{17}([0-9]|X|x)$)";
    ...
    private static final Pattern PHONE_REG         = Pattern
            .compile("(" + TELEPHONE_PATTERN + ")|(" + MOBILE_PATTERN + ")");
