 ...
 * 根据得到的url，爬取网页内容，下载到本地保存。此处需要引用
...
public class DownLoadFile {
  ...
  /* 2.生成 GetMethod 对象并设置参数 以get方式请求*/
        ...
        getMethod.getParams().setParameter("User-Agent", "Mozilla/4.0 (compatible; MSIE 5.0; Windows NT; DigExt)");
