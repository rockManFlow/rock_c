...
public class RSA {
    ...
    public static void main(String[] s) throws Exception {
        ...
        String url="D:\\myProjects\\tools\\src\\main\\resources\\port_submit_merket.public";
        ...
        url="D:\\myProjects\\tools\\src\\main\\resources\\port_submit_merket.private";
        FileOutputStream outputStream1=new FileOutputStream(url);
        outputStream1.write(privateKey.getBytes());
        outputStream1.flush();
        outputStream1.close();
